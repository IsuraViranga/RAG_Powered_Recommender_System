...
const suggestions = [
  ...
  "Young heroes on adventures",
  "Fantasy with magic schools",
    ...
    >
      <div
        style={{
          ...
          height: "36px",
          borderRadius: "8px",
          background: `conic-gradient(#f4a261 ${pct * 3.6}deg, rgba(255,255,255,0.06) 0deg)`,
          display: "flex",
          alignItems: "center",
      ...
      <div style={{ minWidth: 0 }}>
        <div style={{ fontSize: "13px", fontWeight: "600", color: "#f0ece4", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
          {book.title}
        </div>
        <div style={{ fontSize: "11px", color: "#8a8478", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: "2px" }}>
          {book.genre}
        </div>
      </div>
    </div>
    ...
    >
      <div style={{ display: "flex", alignItems: "flex-end", gap: "8px", flexDirection: isUser ? "row-reverse" : "row" }}>
        ...
        <div
          style={{
            ...
            color: isUser ? "#1a1612" : "#e8e2d9",
            fontSize: "14px",
            lineHeight: "1.65",
            fontWeight: isUser ? "500" : "400",
            fontFamily: isUser ? "'DM Sans', sans-serif" : "'Lora', serif",
          }}
        >
          {msg.content}
        </div>
      ...
      {msg.books && msg.books.length > 0 && (
        <div style={{ maxWidth: "75%", width: "100%", display: "flex", flexDirection: "column", gap: "6px", paddingLeft: "38px" }}>
          <div style={{ fontSize: "11px", color: "#6b6560", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "2px" }}>
            Retrieved matches
          </div>
...
export default function App() {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hello! I'm your personal book guide. Tell me what kind of story you're in the mood for, and I'll find the perfect match from our collection.",
    },
  ]);
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600&family=DM+Mono:wght@400;500;700&family=Lora:ital,wght@0,400;0,500;1,400&display=swap');
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: "11px", color: "#6b6560", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "6px" }}>
              RAG Chatbot
            </div>
            <div style={{
            ...
            <div style={{ fontSize: "12px", color: "#5a5550", marginTop: "4px", fontFamily: "'Lora', serif", fontStyle: "italic" }}>
          ...
          <div style={{ marginTop: "auto" }}>
            <div style={{
              ...
              {["FAISS · Vector Search", "Sentence-BERT · Embeddings", "Llama 3.1 · Generation", "Flask · API"].map((s, i) => (
                <div key={i} style={{ fontSize: "11px", color: "#6b6560", padding: "2px 0", fontFamily: "'DM Mono', monospace" }}>
                  {s}
                </div>
              ))}
            </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: "12px", color: "#5a5550", marginTop: "2px" }}>Powered by RAG · {messages.length - 1} messages</div>
            </div>
            <div style={{
          ...
          <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  background: input.trim() && !loading
                    ? "linear-gradient(135deg, #f4a261, #e76f51)"
                    : "rgba(255,255,255,0.06)",
                  color: input.trim() && !loading ? "#1a1612" : "#4a4540",
            ...
            <div style={{ fontSize: "11px", color: "#3a3530", textAlign: "center", marginTop: "10px" }}>
